...
from in_colorization_dataloader import DatasetColorization
...
def get_args():
    ...
    parser.add_argument('--output_dir', default='./output_dir/colorization')
    parser.add_argument('--data_path', default="../datasets/imgnet/")
...
def _generate_result_for_canvas(args, model, canvas):
    ...
    canvas = torch.einsum('chw->hwc', canvas[0])
