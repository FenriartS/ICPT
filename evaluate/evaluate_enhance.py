...
from enhance_dataloader import DatasetEnhance
...
def get_args():
    ...
    parser.add_argument('--output_dir', default='./output_dir/enhance')
    parser.add_argument('--data_path', default="")
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--tta_option', default=0, type=int)
    parser.add_argument('--ckpt', default='./pretrained_model/checkpoint-3400.pth', help='resume from checkpoint')
...
def evaluate(args):
    ...
    ds = DatasetEnhance(args.data_path, image_transform, mask_transform)
